...
if __name__ == '__main__':
    ...
    all_blocks["ERROR"] = all_blocks[["{}_ERROR".format(r) for r in races]].mean(axis=1)


    for race in races:
        all_counties["{}_ERROR".format(race)] = all_counties["{}_2".format(race)] - all_counties[race]

    all_counties["ERROR"] = all_counties[["{}_ERROR".format(r) for r in races]].mean(axis=1)
    ...
    if topdown:
        plt.ylabel("topdown - released")
    elif toydown:
        plt.ylabel("toydown - synthetic")
    elif swapped2:
        plt.ylabel("swapped - synthetic")
    elif swapped10:
        plt.ylabel("swapped - synthetic")
    # plt.ylim(-0.1, 2.1)
    ...
    if topdown:
        ...
        plt.savefig("errors_swapped10_counties.png", dpi=1000)
    ...
    if topdown:
        ...
        plt.savefig("errors_swapped10_blocks.png", dpi=1000)
